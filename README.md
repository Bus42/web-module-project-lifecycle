...
This is an important step for any project you will be working on. You will want to 
* plan out what data you will need

* which component will manage that data via state
